<template>
    <section class="text-white mt-20" id="contact">
        ...
        <div class="grid md:grid-cols-2 gap-4 relative px-4 xl:px-16 mt-8" data-aos="zoom-in-up">
            <div>
                <p class="text-[#adb7be]">If you're looking to develop a sophisticated, reliable, and user-friendly app, I'd love to help bring your vision to life. With my expertise in modern development practices and a keen eye for detail, I ensure that every project is crafted to perfection. Let's connect and discuss how we can create an exceptional app together!
                </p>
                <div class="col-lg-4 col-md-4 mb-lg-0 mt-5">
                    <div class="flex mb-10 items-center">
                        ...
                        <div class="ml-5 text-white">
                            <h4>Email</h4>
                            <p>rathorsourabh3110@gmail.com</p>
                        </div>
                    </div>
                    <div class="flex mb-10 items-center">
                        <div class="p-2"
                    ...
                    <div class="flex mb-10 items-center">
                        ...
                        <div class="ml-5 text-white">
                            <h4>LinkedIn</h4>
                            <p>www.linkedin.com/in/sourabh-kumar-singh-332b31202</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form class="flex flex-col p-2" data-aos="zoom-in-up" >
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="subject" class="bg-[#111827] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5"
