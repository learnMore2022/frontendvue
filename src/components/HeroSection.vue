            ...
            <div class="grid lg:grid-cols-2 gap-10 xl:gap-14 relative pt-24 lg:max-w-none max-w-2xl md:max-w-3xl mx-auto">
                <div class="lg:py-6">
                    ...
                    <p class="text-gray-300 pt-8 text-center lg:text-left mx-auto max-w-xl">
                        Over 9 years of experience in designing, developing and delivering user-centric distributed architecture software application using Java/J2EE and XML Technologies and frontend Technologies like JavaScript and Vue.js  
                    </p>
